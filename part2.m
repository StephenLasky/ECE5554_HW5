...
% use testX to find closest match in trainX
% recall: testX is k x numTest ... trainX is k x numTrain
distances = pdist2(trainX',testX');  
[vals, closestMatchIdxs] = min(distances);
testY = trainY(closestMatchIdxs);
